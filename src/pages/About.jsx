    ...
    <section className="about-page">
      <div className={`about-container ${isVisible ? "animate-in" : ""}`}>
        ...
        <div className="about-description">
            ...
            <p>
              Quando não estou imerso no software, meu laboratório ganha vida com projetos de hardware, experimentações com eletrônica e prototipagem em <strong>3D</strong>. Acredito que a verdadeira inovação acontece exatamente na intersecção entre o desenvolvimento digital e o mundo físico.
            </p>
          </div>
          ...
          <div className="about-extras">
            <div className="extra-card">
              ...
              <span className="extra-value">Gym, Motocross, Game and Dev</span>
            </div>
            <div className="extra-card social-link">
              <span className="extra-label">CONNECT_SIGNAL: </span>
              <a href="https://www.linkedin.com/in/jos%C3%A9-henrique-carvalho-6b1599372/" target="_blank" rel="noreferrer">
                LINKEDIN_STATION ↗
              </a>
            </div>
          </div>
