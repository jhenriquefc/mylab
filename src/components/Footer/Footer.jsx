    ...
    <footer className="sap-footer">
      <div className="status-bar">
        ...
        <div className="status-right">
          <div className="status-item">
            <a href="https://www.linkedin.com/in/josé-henrique-carvalho-6b1599372" target="_blank" rel="noreferrer">LINKEDIN</a>
          </div>
          <div className="status-item">
            <a href="https://github.com/jhenriquefc" target="_blank" rel="noreferrer">GITHUB</a>
          </div>
